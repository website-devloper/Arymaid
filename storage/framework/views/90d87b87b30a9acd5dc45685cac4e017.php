                    ...
                    <div class="tab-content tab-content-carousel">
                        <div class="tab-pane p-0 fade show active" id="trending-all-tab" role="tabpanel"
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height " data-toggle="owl"
                                ...
                                <?php $__currentLoopData = $latestProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Lproduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <span class="product-label label-new">New</span>
                                        <a href="/singleProduct/<?php echo e($Lproduct->id); ?>">
                                            <img src="<?php echo e(asset('/productsImage/'.$Lproduct->image)); ?>"
                                                alt="Product image" class="product-image">
                                        </a>

                                        <div class="product-action-vertical">
                                            <!-- /////////////////////////////////////////////////////////////////////////////////////////// -->
                                            <form action="/wishlist/<?php echo e($Lproduct->id); ?>" method="GET">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit"
                                        ...
                                        <div class="product-action">
                                            <a href="/cart/<?php echo e($Lproduct->id); ?>" class="btn-product btn-cart"><span>add to
                                                    cart</span></a>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <div class="product-action-vertical">
                                                <form action="/wishlist/<?php echo e($product->id); ?>" method="GET">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit"
                                                    class="btn-product-icon btn-wishlist btn-expandable"><span>add to
                                                        wishlist</span></button>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <nav aria-label="Page navigation">
							    <ul class="pagination justify-content-center">
							        ...
							        <li class="page-item"><a class="page-link" ><?php echo e($products->links('pagination::bootstrap-5')); ?></a></li>
...
<?php echo $__env->make('layouts.masterHome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mikasa Ackerman\arymaid\Arymaid\resources\views/components/home.blade.php ENDPATH**/ ?>