                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <div class="product-action-vertical">
                                            ...
                                            <!-- //////////////////////////////////////////////////////////////////////////////////////////// -->
                                            <a href="/compare/{{$Lproduct->id}}" class="btn-product-icon"
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="/singleProduct/{{$Lproduct->id}}">{{$Lproduct->name}}</a></h3>
                                        <!-- End .product-title -->
                                        ...
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <button type="submit"
                                                    ...
                                                    <a href="/compare/{{$product->id}}" class="btn-product-icon"
                                                title="Compare"><i class="icon-random"></i><span>Compare</span></a>
