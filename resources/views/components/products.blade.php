                                ...
                                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                    <div class="product product-7 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="/singleProduct/{{$produit->id}}">{{$produit->name}}</a></h3><!-- End .product-title -->
                                            ...
                                            <div class="filter-items filter-items-count">
                                                ...
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="category[]" value="{{$categorie->id}}" class="custom-control-input" id="cat-{{$categorie->id}}" {{ in_array($categorie->id, (array) request('category', [])) ? 'checked' : '' }}>
